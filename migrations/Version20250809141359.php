 ...
 */
final class Version20250809141359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, requesting_user_id INT DEFAULT NULL, assigned_user_id INT DEFAULT NULL, assigned_group_id INT DEFAULT NULL, resolved_by_id INT DEFAULT NULL, closed_by_id INT DEFAULT NULL, date_created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_modified DATETIME DEFAULT NULL, date_due DATETIME DEFAULT NULL, subject VARCHAR(255) NOT NULL, original_message VARCHAR(255) NOT NULL, resolved_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', closed_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_97A0ADA32A841BBC (requesting_user_id), INDEX IDX_97A0ADA3ADF66B1A (assigned_user_id), INDEX IDX_97A0ADA38359DF4E (assigned_group_id), INDEX IDX_97A0ADA36713A32B (resolved_by_id), INDEX IDX_97A0ADA3E1FA7797 (closed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ticket_history (id INT AUTO_INCREMENT NOT NULL, ticket_id INT NOT NULL, related_user_id INT NOT NULL, date_created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', message VARCHAR(255) DEFAULT NULL, INDEX IDX_2B762919700047D2 (ticket_id), INDEX IDX_2B76291998771930 (related_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
